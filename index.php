    ...
    <section class="food-search text-center">
        <div class="container">
            ...
            <form action="<?php echo SITEURL; ?>food-search.php" method="POST">
                <input type="search" name="search" placeholder="choice your product and searching" required>
    ...
    <section class="food-menu">
        <div class="container">
            <h2 class="text-center">Our foods Menu</h2>
        ...
        <p class="text-center">
            <a href="<?php echo SITEURL; ?>foods.php ?>">See All Image</a>
        </p>
    </section>
